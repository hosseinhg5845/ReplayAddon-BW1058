package dev.sosis.replay;

import de.tr7zw.changeme.nbtapi.NBTItem;
import dev.sosis.replay.configs.ConfigManager;
import dev.sosis.replay.configs.language.en;
import dev.sosis.replay.configs.language.ILang;
import dev.sosis.replay.databases.IDatabase;
import dev.sosis.replay.databases.MySQL;
import dev.sosis.replay.databases.PostgreSQL;
import dev.sosis.replay.databases.SQLite;
import dev.sosis.replay.guis.Button;
import dev.sosis.replay.managers.IManager;
import dev.sosis.replay.managers.playingmode.PlayingManager;
import dev.sosis.replay.managers.proxymode.ProxyModeManager;
import dev.sosis.replay.managers.recordingmode.RecordingManager;
import dev.sosis.replay.managers.sharedmode.SharedManager;
import dev.sosis.replay.spigui.SpiGUI;
import dev.mrflyn.replayaddon.versionutils.*;
import dev.sosis.replay.versionutils.*;
...
public class ReplayPlugin extends JavaPlugin {
    ...
    public static ReplayPlugin plugin;
