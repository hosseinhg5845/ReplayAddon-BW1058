package dev.sosis.replay.advancedreplayhook;
...
import dev.sosis.replay.versionutils.SupportPAPI;
import dev.sosis.replay.versionutils.Util;
import dev.sosis.replay.guis.PlayerReplaysGUI;
...
public class GameReplayHandler {
    ...
    public static void stopRecording(GameStateChangeEvent e, boolean updateCache){
        ...
        Bukkit.getScheduler().runTaskAsynchronously(ReplayPlugin.plugin, ()->{
            ReplayPlugin.plugin.db.saveGameReplayCache(cache);
